...
::MOZILLA FIREFOX ESR
REM | ===================
REM | Purpose: Silently install Mozilla Firefox ESR via PDQ Deploy.
REM | Requirements: 
...
set BINARY=Firefox Setup 68.2.0esr.msi
set FLAGS=DESKTOP_SHORTCUT=false INSTALL_MAINTENANCE_SERVICE=false OPTIONAL_EXTENSIONS=false /quiet /norestart

REM | ========
REM | INSTALL
REM | ========

REM | Stop running processes that may interfere with install
