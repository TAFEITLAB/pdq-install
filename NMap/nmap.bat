...
set BINARY=nmap-7.80-setup.exe
set FLAGS=/S
set NIRCMD="\\CONT-01\PDQRepository\Utilities\nircmd.exe"
set SHORTCUTPATH="C:\ProgramData\Microsoft\Windows\Start Menu\Programs"
set ZENMAP-LOCATION="C:\Program Files (x86)\Nmap\zenmap.exe"
set SHORTCUT_NAME="Zenmap - NMap GUI"
...
REM | 
%NIRCMD% shortcut %ZENMAP-LOCATION% %SHORTCUTPATH% %SHORTCUT_NAME%
