...
REM | UltraViewer
REM | =========================
REM | Purpose: Silently install UltraViewer via PDQ Deploy.
REM | Requirements: 
...
set BINARY=UltraViewer_setup_6.2_en.exe
set FLAGS=/VERYSILENT /SUPPRESSMSGBOXES /NOCANCEL /NORESTART /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS
