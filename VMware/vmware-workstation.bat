...
REM | =========================
REM | VMWare Workstation Pro
REM | =========================
REM | Purpose: Silently install PACKAGE via PDQ Deploy.
REM | Requirements:
REM |   - Script in same directory as binary.
REM |   - Script matches binary name.
REM |   - Add Serial Key as paramenter to PDQ Deploy package
REM |   - Run Uninstall script first. Target requires reboot before install.
REM | Author: Tim Dunn
...
set BINARY=VMware-workstation-full-15.5.1-15018445.exe
