...
REM | =====================
REM | WINSCP FILE TRANSFER
REM | =====================
REM | Purpose: Silently install WinSCP SFTP/FTP/SCP File Transfer Client via PDQ Deploy.
REM | Requirements: 
...
set LOCATION=
set BINARY=WinSCP-5.17.3-Setup.exe
set FLAGS=/VERYSILENT /NOCANDY /NORESTART  /CLOSEAPPLICATIONS /MERGETASKS="!desktopicon" /ALLUSERS
